...
inherit python-single-r1 xdg-utils waf-utils
...
if [[ ${PV} == *9999 ]]; then
	...
	SRC_URI="https://github.com/kushview/Element/releases/download/${PV}/element-${PV}.tar.gz -> ${P}.tar.gz"
	RESTRICT="mirror"
	KEYWORDS="amd64"
	S="${WORKDIR}/element-${PV}"
fi
LICENSE="LGPL-3"
SLOT="0"
